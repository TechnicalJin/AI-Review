...
const CreateClient = () => {
  ...
  const processLogoFile = (file) => {
    if (file) {
      ...
      if (file.size > maxSize) {
        setErrors((prev) => ({ ...prev, logo: 'File size exceeds 2 MB.' }));
        return;
      }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setGlobalSuccess('Client created successfully!');
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-8 lg:py-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 dark:text-slate-400">
                Add a new client to the review generation system
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-700 overflow-hidden">
          <form onSubmit={handleSubmit}>
            {/* Basic Info Section */}
            <FormSection title="Basic Information" icon="fas fa-user">
              <FormGrid>
                {/* Name */}
                <Input
                  type="text"
            ...
            {/* Logo Upload Section */}
            <FormSection title="Company Logo" icon="fas fa-image">
                ...
                <div className="flex-1 w-full">
                  ...
                  >
                    ...
                    <div className="w-16 h-16 rounded-full bg-indigo-100 dark:bg-indigo-900/30 flex items-center justify-center mx-auto mb-4">
                      <i className="fas fa-cloud-upload-alt text-2xl text-indigo-600 dark:text-indigo-400"></i>
                    </div>
                    <p className="text-slate-700 dark:text-slate-300 font-medium mb-1">
                      Drag & drop your logo here
                    </p>
                    <p className="text-slate-500 dark:text-slate-400 text-sm">
                      or <span className="text-indigo-600 dark:text-indigo-400 font-medium">browse</span> to choose a file
                    </p>
                    <p className="text-slate-400 dark:text-slate-500 text-xs mt-3">
                      Max 2 MB (JPEG or PNG)
                    </p>
                  </div>
            ...
            {/* Tags Section */}
            <FormSection title="Review Tags" icon="fas fa-tags" isLast={true}>
              <p className="text-slate-500 dark:text-slate-400 text-sm mb-6">
                Add at least 10 tags that describe your business services. These will be used to generate reviews.
              </p>
                ...
                <div className="h-2 bg-slate-200 dark:bg-slate-700 rounded-full overflow-hidden">
                  <div
                    className={`h-full motion-slow rounded-full ${
                      tags.size >= 10 ? 'bg-emerald-500' : 'bg-indigo-500'
                    }`}
